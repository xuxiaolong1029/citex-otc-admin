			...
			<div class="content-top">
				...
				<p>
					...
					<el-dropdown trigger="hover">
						<span class="el-dropdown-link user-info-inner"><img alt="" src="../assets/img/user.png" /> &nbsp;{{initData.realName||'--'}}</span>
...
<script>
	...
	export default {
		...
		computed: {
			...mapState(["pageHeight","initData","userToken"]),
		},
		mounted() {
			this.getActive(this.$route.path);
			if(this.userToken&&Object.keys(this.initData).length===0){
...
<style lang="less" scoped>
	.page-home{
		width: 100%;height: 100%;display: flex;min-width: 1300px;
		.page-left{
			height: 100%;
			background-color: #001529;
			h1{
